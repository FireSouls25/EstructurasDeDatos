...
- Python 3
- Libreria tkinter ya implementada en python

### Características

- Es posible cambiar la posición de la manecilla de las horas con el mouse
- Se puede colocar una hora especifica colocando los numeros en los botones abajo del reloj
